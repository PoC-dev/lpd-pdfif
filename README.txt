...
Its main advantage is that it looks inside the print jobs to place the
...
directory! The Makefile takes care of that. This might have possible
...
For me, its main function I use is to get PDFs from spooled output of older
versions of OS/400. PDF output was added considerably late, through a
...
rather be read from a configuration file. Error recovery is minimal. Manpage isn't
installed by default. Debian packaging hasn't been tested at all. I'm releasing
it in its current state because I think it could benefit skilled people anyway.
...
==========================
To do its work, I do something very unusual: Calling external applications.
...
all others are only needed for certain conversions.
- file
